...
- After each successful download, `Thumbnailer` extracts a frame at 1 second to an atomic matching `.jpg` sidecar. Emby uses this `{video-name}.jpg` file as the video's primary image.
